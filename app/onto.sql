...
COPY api_ontology (id, name, displayurl, tablename, owner, description, classname, is_entity, "group") FROM stdin;
...
69      Term    \N      api_term        api     \N      Term    t       api
70      DataSource      \N      api_datasource  api     \N      DataSource      t       api
72      Staff           seafood_staff   seafood         Staff   t       seafood
74      Gene    \N      gene_expression_gene    gene_expression \N      Gene    t       gene_expression
76      Target  \N      gene_experssion_target  gene_experssion \N      Target  t       gene_experssion
77      Target          gene_expression_target  gene_expression         Target  t       gene_expression
...
--
-- Name: api_ontology_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pinf
--
